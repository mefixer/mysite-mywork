...
<div class="container-fluid">
    ...
    <p>
        <a href="<?php echo base_url(); ?>/rolusuarios" class="btn btn-sm btn-outline-primary"><i class="fas fa-thermometer-quarter"></i> Volver a lista de Roles</a>
    </p>
                    ...
                    <tbody>
                        <?php foreach ($datos as $dato) { ?>
                            <tr>
                                ...
                                <td><a href="#" data-href="<?php echo base_url() . '/rolusuarios/reingresar/' . $dato['id']; ?>" data-toggle="modal" data-target="#modal-confirma" data-placement="top" title="Restaurar registro"><i class="fas fa-level-up-alt"></i></a></td>
                            </tr>
                        <?php } ?>
                    </tbody>
                </table>
