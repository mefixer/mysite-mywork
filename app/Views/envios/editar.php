...
<main>
    <div class="container-fluid">
        ...
        <?php } ?>
        <form method="POST" action="<?php echo base_url(); ?>/envios/actualizar" autocomplete="off">
            <?php csrf_field(); ?>
            ...
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-12 col-sm-6">
                        ...
                        <input type="text" class="form-control" id="valor" name="valor" value="<?php echo $datos['valor'] ?>" require>
                    </div>
                </div>
            </div>
            <br>
