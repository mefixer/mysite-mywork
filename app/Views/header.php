...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link">
                    <span>Sistema de administración web</span></a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo">
                    <i class="fas fa-tv"></i>
                    <span>Web clientes abrazaté</span>
                </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseFor" class="collapse" aria-labelledby="headingFor" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<?php echo base_url(); ?>/intermedios"><i class="fas fa-truck-loading"></i> Stock</a>
                        <a class="collapse-item" href="<?php echo base_url(); ?>/destacados"><i class="fas fa-wave-square"></i> Productos</a>
                        <a class="collapse-item" href="<?php echo base_url(); ?>/posteos"><i class="fas fa-rocket"></i> Interacciones</a>
                    </div>
                </div>
            </li>
            <!-- Divider -->
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                                ...
                                <a class="dropdown-item" href="#" data-toggle="modal" data-target="#logoutModal">
                                    <i class="fas fa-sign-out-alt fa-sm fa-fw mr-2 text-gray-400" href="<?php echo base_url(); ?>/usuarios/logout"></i>
                                    Cerrar sesión
                                </a>
                            </div>
                        </li>
